              ...
              <div class="card-body">
                <form action="core/handleForms.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <small class="form-text text-muted">Optional: Choose a category for your article</small>
                  </div>
                  <div class="form-group">
                  ...
                  <button type="submit" class="btn btn-primary btn-lg" name="insertAdminArticleBtn">
          ...
          if (confirm('Are you sure you want to delete this article?')) {
            $.ajax({
              ...
              success: function (data) {
                if (data) { location.reload(); } else { alert('Deletion failed'); }
              }
            });
          }
        });
